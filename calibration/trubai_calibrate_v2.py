...
Steps:
  ...
  2. Run §4 calibration at alpha=0.5 ONLY
...
app       = modal.App("trubai-calibrate-v2", image=image)
...
class CalibrateV2:
    ...
    def setup(self):
        ...
        print("Setup complete. bias_v2.pt active (suppression-only, alpha=0.5).")
    ...
    def calibrate(self) -> dict:
        ...
        print()
        print("=" * 60)
        print("§4 RERUN — bias_v2.pt (suppression-only) alpha=0.5")
        print("=" * 60)
